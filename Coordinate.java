...
/**
 * The Coordinate class is a helper class to assist in your solution in MazeSolver. You may
 * use it as you see fit in your MazeSolver solution but *DO NOT* modify the class otherwise
...
public class Coordinate {
    ...
    // *package private*, which means dropping the 'private' modifier, or use getter methods.
    private int x, y;
